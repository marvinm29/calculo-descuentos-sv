const TASAS = [
  ...
  },
  {
    ...
    valor: 'Exento',
    detalle: 'Base gravable hasta $338.67',
    fuente: 'Art. 37 LISR (D.O. Tomo 447, 30/04/2025)',
    url: 'https://www.mh.gob.sv',
  },
  {
    concepto: 'Renta — Tramo II',
    valor: '10% + $17.67',
    detalle: 'Base gravable de $338.68 a $761.90',
    fuente: 'Art. 37 LISR',
  ...
  },
  {
    ...
    valor: '20% + $60.00',
    detalle: 'Base gravable de $761.91 a $1,904.76',
    fuente: 'Art. 37 LISR',
    url: 'https://www.diariooficial.gob.sv',
  },
  {
    ...
    valor: '30% + $288.57',
    detalle: 'Base gravable desde $1,904.77',
    fuente: 'Art. 37 LISR',
    url: 'https://www.diariooficial.gob.sv',
  },
  {
